...
exports.getPlaylistVideosInfo = getPlaylistVideosInfo;
var defaultdict_js_1 = require("../../helpers/defaultdict.js");
var durationProcessor_js_1 = require("../../helpers/durationProcessor.js");
function getPlaylistVideosInfo(apiKey, videoIds) {
    return __awaiter(this, void 0, void 0, function () {
        var videos, i, batch, commaSepIds, data, url, res, err_1, _i, _a, item, videoId, title, uploadDate, rawDuration, processedDuration, likeCount, commentCount, viewCount;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _b.label = 1;
                case 1:
                    if (!(i < videoIds.length)) return [3 /*break*/, 8];
                    batch = videoIds.slice(i, i + 50);
                ...
                case 5:
                    ...
                    console.error("Error w API call:", err_1);
                    return [2 /*return*/, {
                            result: null,
                            error: true,
                            errorMessage: "Error message: ".concat(err_1)
                        }];
                case 6:
